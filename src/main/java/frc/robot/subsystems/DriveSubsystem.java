...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final MAXSwerveModule m_frontLeft = new MAXSwerveModule(
      CanIDs.kCAN_DriveLeftFront,
      CanIDs.kCAN_TurnLeftFront,
      DriveConstants.kFrontLeftChassisAngularOffset);

  private final MAXSwerveModule m_frontRight = new MAXSwerveModule(
      CanIDs.kCAN_DriveRightFront,
      CanIDs.kCAN_TurnRightFront,
      DriveConstants.kFrontRightChassisAngularOffset);

  private final MAXSwerveModule m_rearLeft = new MAXSwerveModule(
      CanIDs.kCAN_DriveLeftBack,
      CanIDs.kCAN_TurnLeftBack,
      DriveConstants.kBackLeftChassisAngularOffset);

  private final MAXSwerveModule m_rearRight = new MAXSwerveModule(
      CanIDs.kCAN_DriveRightBack,
      CanIDs.kCAN_TurnRightBack,
      DriveConstants.kBackRightChassisAngularOffset);

  // The gyro sensor
  public final PigeonIMU m_gyro = new PigeonIMU(9);
...
*/
  ...
  public void setCoast(){
    m_frontLeft.getDriveMotor().setIdleMode(IdleMode.kCoast);
    m_frontRight.getDriveMotor().setIdleMode(IdleMode.kCoast);
    m_rearLeft.getDriveMotor().setIdleMode(IdleMode.kCoast);
    m_rearRight.getDriveMotor().setIdleMode(IdleMode.kCoast);
  }
